        ...
        <?php foreach ($languages as $language) { ?>
            <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="product_description[<?php echo $language['language_id']; ?>][description]"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label>
                            <input type="checkbox" name="is_new" value="1" id="input-is_new" <?php echo (($is_new == 1 || $is_new == '') ? 'checked' : ''); ?> /> &nbsp;Sản phẩm mới
                        </label>
                    </div>
                </div>
                <div class="form-group required">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]"
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-tag<?php echo $language['language_id']; ?>"><span
                            data-toggle="tooltip"
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" name="price" value="<?php echo $price; ?>" placeholder="<?php echo $entry_price; ?>"
    ...
    <div class="col-sm-3">
        <div class="input-group">
            <input type="text" name="quantity" value="<?php echo $quantity; ?>"
                   placeholder="<?php echo $entry_quantity; ?>" id="input-quantity" class="form-control" readonly/>
                    <span class="input-group-btn">
                    <button id="btn-change-quantity" class="btn btn-default" type="button" data-toggle="modal"
                            data-target="#dialog-quantity"><span class="glyphicon glyphicon-pencil"></span></button>
                    </span>
        </div>
    </div>
    <input type="hidden" name="quantity_detail" value="<?php echo str_replace('"', '_nn_', $quantity_detail); ?>"
           id="input-quantity-detail"/>
</div>
<div class="form-group">
    ...
    <div class="col-sm-3">
        <div class="input-group date">
            <input type="text" name="date_available" value="<?php echo $date_available; ?>"
                   placeholder="<?php echo $entry_date_available; ?>" data-date-format="YYYY-MM-DD"
        ...
        <div class="row">
            <div class="col-sm-4">
                <input type="text" name="length" value="<?php echo $length; ?>"
                       placeholder="<?php echo $entry_length; ?>" id="input-length" class="form-control"/>
            </div>
            <div class="col-sm-4">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="manufacturer" value="<?php echo $manufacturer ?>"
                   placeholder="<?php echo $entry_manufacturer; ?>" id="input-manufacturer" class="form-control"/>
            ...
            <?php foreach ($product_attributes as $product_attribute) { ?>
                <tr id="attribute-row<?php echo $attribute_row; ?>">
                    <td class="text-left" style="width: 40%;"><input type="text"
                                                                     ...
                                                                     class="form-control"/>
                        <input type="hidden" name="product_attribute[<?php echo $attribute_row; ?>][attribute_id]"
                    ...
                    <td class="text-left"><?php foreach ($languages as $language) { ?>
                        ...
                        <?php } ?></td>
                    <td class="text-left">
                        <button type="button" onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();"
            ...
            <tr>
                ...
                <td class="text-left">
                    <button type="button" onclick="addAttribute();" data-toggle="tooltip"
                            title="<?php echo $button_attribute_add; ?>" class="btn btn-primary"><i
...
<div class="col-sm-2">
    <ul class="nav nav-pills nav-stacked" id="option">
        ...
        <?php foreach ($product_options as $product_option) { ?>
            <li><a href="#tab-option<?php echo $option_row; ?>" data-toggle="tab"><i class="fa fa-minus-circle"
    ...
    <div class="tab-content">
        ...
        <?php foreach ($product_options as $product_option) { ?>
            <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                <input type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_id]"
                ...
                <input type="hidden" name="product_option[<?php echo $option_row; ?>][option_id]"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="product_option[<?php echo $option_row; ?>][required]"
                                id="input-required<?php echo $option_row; ?>" class="form-control">
                ...
                <?php if ($product_option['type'] == 'text') { ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="product_option[<?php echo $option_row; ?>][value]"
                                   value="<?php echo $product_option['value']; ?>"
                                   placeholder="<?php echo $entry_option_value; ?>"
                                   id="input-value<?php echo $option_row; ?>" class="form-control"/>
                        </div>
                    </div>
                <?php } ?>
                <?php if ($product_option['type'] == 'textarea') { ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="product_option[<?php echo $option_row; ?>][value]" rows="5"
                                      placeholder="<?php echo $entry_option_value; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group date">
                                <input type="text" name="product_option[<?php echo $option_row; ?>][value]"
                                       value="<?php echo $product_option['value']; ?>"
                                       placeholder="<?php echo $entry_option_value; ?>" data-date-format="YYYY-MM-DD"
                                       id="input-value<?php echo $option_row; ?>" class="form-control"/>
                            <span class="input-group-btn">
                            <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                            </span></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group time">
                                <input type="text" name="product_option[<?php echo $option_row; ?>][value]"
                                       value="<?php echo $product_option['value']; ?>"
                                       placeholder="<?php echo $entry_option_value; ?>" data-date-format="HH:mm"
                                       id="input-value<?php echo $option_row; ?>" class="form-control"/>
                            <span class="input-group-btn">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group datetime">
                                <input type="text" name="product_option[<?php echo $option_row; ?>][value]"
                                       value="<?php echo $product_option['value']; ?>"
                                       placeholder="<?php echo $entry_option_value; ?>"
                                       data-date-format="YYYY-MM-DD HH:mm" id="input-value<?php echo $option_row; ?>"
                                       class="form-control"/>
                            <span class="input-group-btn">
                            <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                            </span></div>
                    ...
                    <div class="table-responsive">
                        <table id="option-value<?php echo $option_row; ?>"
                                ...
                                <tr id="option-value-row<?php echo $option_value_row; ?>">
                                    ...
                                    <td class="text-right"><select
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="<?php echo $entry_price; ?>" class="form-control"/></td>
                                    <td class="text-right"><select
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="<?php echo $entry_points; ?>" class="form-control"/></td>
                                    <td class="text-right"><select
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="<?php echo $entry_weight; ?>" class="form-control"/></td>
                                    <td class="text-left">
                                        <button type="button"
                            ...
                            <tr>
                                <td colspan="6"></td>
                                <td class="text-left">
                                    <button type="button" onclick="addOptionValue('<?php echo $option_row; ?>');"
                                            data-toggle="tooltip" title="<?php echo $button_option_value_add; ?>"
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <?php foreach ($product_recurrings as $product_recurring) { ?>
                ...
                <tr id="recurring-row<?php echo $recurring_row; ?>">
                    <td class="text-left"><select name="product_recurrings[<?php echo $recurring_row; ?>][recurring_id]"
                                                  class="form-control">
                    ...
                    <td class="text-left"><select
                            name="product_recurrings[<?php echo $recurring_row; ?>][customer_group_id]"
                            class="form-control">
                    ...
                    <td class="text-left">
                        <button type="button" onclick="$('#recurring-row<?php echo $recurring_row; ?>').remove()"
                                data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i
                                class="fa fa-minus-circle"></i></button>
                    </td>
                </tr>
            ...
            <tr>
                ...
                <td class="text-left">
                    <button type="button" onclick="addRecurring()" data-toggle="tooltip"
                            title="<?php echo $button_recurring_add; ?>" class="btn btn-primary"><i
                            class="fa fa-plus-circle"></i></button>
                </td>
            </tr>
            </tfoot>
            ...
            <?php foreach ($product_discounts as $product_discount) { ?>
                <tr id="discount-row<?php echo $discount_row; ?>">
                    ...
                    <td class="text-right"><input type="text"
                                                  ...
                                                  placeholder="<?php echo $entry_quantity; ?>" class="form-control"/>
                    </td>
                    <td class="text-right"><input type="text"
                    ...
                    <td class="text-left">
                        <button type="button" onclick="$('#discount-row<?php echo $discount_row; ?>').remove();"
                                data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i
                                class="fa fa-minus-circle"></i></button>
                    </td>
                </tr>
            ...
            <tr>
                ...
                <td class="text-left">
                    <button type="button" onclick="addDiscount();" data-toggle="tooltip"
                            title="<?php echo $button_discount_add; ?>" class="btn btn-primary"><i
                            class="fa fa-plus-circle"></i></button>
                </td>
            </tr>
            </tfoot>
        ...
        <table id="special" class="table table-striped table-bordered table-hover">
            ...
            <?php foreach ($product_specials as $product_special) { ?>
                <tr id="special-row<?php echo $special_row; ?>">
                    ...
                    <td class="text-right"><input type="text" name="product_special[<?php echo $special_row; ?>][price]"
                ...
                <?php foreach ($colorList as $key => $row) : ?>
                    <?php if (!in_array($row['color'], $colorUsed)) : ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="color-round" data-color="<?php echo $row['color']; ?>"
                                     style="width: 45px; height: 45px; margin: auto; background-color: <?php echo $row['color']; ?>; <?php echo($row['color'] == '#ffffff' ? 'border: 1px solid #cccccc;' : ''); ?>"></div>
                            </td>
                            <td class="pan-image">
                                            ...
                                            <a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image"
                                               class="img-thumbnail">
                                                <img src="<?php echo $image['url']; ?>" alt="" title=""
                                                     data-placeholder="<?php echo $image['url']; ?>">
                                            </a>
                                            <input type="hidden" value="<?php echo $image['name']; ?>"
                            ...
                            <td>
                                <button type="button" onclick="addImage(this);" class="btn btn-primary"
                                        data-toggle="tooltip" title data-original-title="Add image"><span
...
<div class="tab-pane" id="tab-reward">
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <input type="text" name="points" value="<?php echo $points; ?>" placeholder="<?php echo $entry_points; ?>"
        ...
        <table class="table table-bordered table-hover">
            ...
            <?php foreach ($stores as $store) { ?>
                <tr>
                    ...
                    <td class="text-left"><select name="product_layout[<?php echo $store['store_id']; ?>]"
                                                  class="form-control">
                            <option value=""></option>
                            <?php foreach ($layouts as $layout) { ?>
        ...
        <div class="input-group-btn">
            ...
            <ul class="dropdown-menu mw80" role="menu">
                <?php foreach ($list_size as $key => $size) : ?>
                    <li <?php echo(($key == 0) ? 'class="active"' : ''); ?>><a href="#"
                                                                               class="select-item"><?php echo $size; ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
...
<div class="modal fade" id="dialog-quantity" tabindex="-1" role="dialog" aria-labelledby="dialog-quantity-label"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pan-modify-quantity">
                <div class="pan-modify-quantity-control">
                    <button type="button" class="btn-add-color btn btn-sm btn-primary">Add color &nbsp;<span
                            class="glyphicon glyphicon-plus-sign"></span></button>
                </div>
