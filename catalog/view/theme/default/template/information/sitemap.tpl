  ...
  <div class="row text-color-common"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <ul>
           <?php /* <li><a href="<?php echo $special; ?>"><?php echo $text_special; ?></a></li> */ ?>
            <li><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a>
              <ul>
                <li><a href="<?php echo $edit; ?>"><?php echo $text_edit; ?></a></li>
                <li><a href="<?php echo $password; ?>"><?php echo $text_password; ?></a></li>
                <?php /*<li><a href="<?php echo $address; ?>"><?php echo $text_address; ?></a></li> */ ?>
            ...
            <?php /*<li><a href="<?php echo $search; ?>"><?php echo $text_search; ?></a></li> */ ?>
