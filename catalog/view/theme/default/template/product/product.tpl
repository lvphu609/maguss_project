                    ...
                    <div class="col-xs-12 col-sm-12 col-lg-2 box-item-image">
                        <?php foreach ($groupColor['images'] as $key => $img) : ?>
                            ...
                            <div class="img-additional">
                                <a class="thumbnail img-lg-item" href="javascript:;"
                                   title="<?php echo $heading_title; ?>"><img class="mh500"
                                                                              src="<?php echo $img['url']; ?>"
                                                                              title="<?php echo $heading_title; ?>"
                                                                              alt="<?php echo $heading_title; ?>"
                                                                              data-large="<?php echo $img['url_lag']; ?>"></a>
                            </div>
                        <?php endforeach; ?>
                    </div>
                    <div class="col-xs-10 col-sm-10 col-lg-10 img-first">
                        <div class="img-additional">
                            <img class="zoom-image-product mh500 img-lg-append" src="<?php echo $imgFirst; ?>"
                                 title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>"
                                 data-large="<?php echo $imgFirstLag; ?>">
                        </div>
                    </div>
    ...
    <div class="box-info-product-detail <?php echo $class; ?>">
                ...
                <?php if (count($group_product_color) > 0) : ?>
                    ...
                    <?php foreach ($group_product_color as $key => $groupColor) : ?>
                        <?php if (!in_array($groupColor['color'], $colorUsed)) : ?>
                            ...
                            <div class="color-item-product-detail-lg <?php echo($key == 0 ? 'active' : ''); ?>"
                                 style="background-color:<?php echo $groupColor['color']; ?>"
                                 data-color="<?php echo $groupColor['color']; ?>">
                                <div class="group-color hide">
                                    <?php if (count($groupColor['images']) > 0) : ?>
                                        ...
                                        <div class="col-xs-10 col-sm-10 col-lg-10 img-first">
                                            <div class="img-additional">
                                                <img class="zoom-image-product mh500 img-lg-append"
                                                     src="<?php echo $imgFirst; ?>"
                                                     title="<?php echo $heading_title; ?>"
                                                     alt="<?php echo $heading_title; ?>"
                                                     data-large="<?php echo $imgFirstLag; ?>">
                                            </div>
        ...
        <div class="pro-button-shipping">
            <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>"
                    class="btn btn-primary btn-lg btn-block button-shipping"><?php echo $button_cart; ?></button>
        </div>
    ...
    <div class="row box-related-product">
        ...
        <div class="product-layout product-grid product-item product-item-current col-lg-4 col-md-4 col-sm-6 col-xs-12">
            <div class="product-thumb">
                <div class="image"><a href="#"><img src="<?php echo $productCurrent['image_url']; ?>"
                                                    alt="Quan Jean mua dong" class="img-responsive"></a></div>
                ...
                <div class="button-group-item text-center">
                    <a id="button-cart-second" href="javascript:;" class="btn btn-product-item button-shipping-second"
                       type="button">
                ...
                <div class="product-thumb product-id-<?php echo $product['product_id']; ?>">
                                ...
                                <?php if (!in_array($groupColor['color'], $colorUsed)) : ?>
                                    ...
                                    <?php if (count($groupColor['images']) > 0) : ?>
                                        <?php foreach ($groupColor['images'] as $key1 => $img) : ?>
                                            ...
                                            ?>
                                            <?php if ($key1 == 0) : ?>
                                                <div class="color-item <?php echo($key == 0 ? 'active' : ''); ?>"
                                                     style="background-color:<?php echo $groupColor['color']; ?>"
                                                     data-color="<?php echo $groupColor['color']; ?>"
                                                     data-url="<?php echo $img['url']; ?>"
                                                     data-root="product-id-<?php echo $product['product_id']; ?>"></div>
                                            <?php endif; ?>
                    ...
                    <div class="image">
                        <a href="<?php echo $product['href']; ?>">
                            ...
                            <?php } ?>
                            <img src="<?php echo $product_thumb; ?>" alt="<?php echo $product['name']; ?>"
                    ...
                    <div class="caption text-center">
                        <div class="top-desc">
                            <span class="title"><a
                                    href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></span>
                    ...
                    <div class="button-group-item text-center">
                        <a href="<?php echo $product['href']; ?>" class="btn btn-product-item"><span
                                class=""><?php echo $button_cart; ?></span></a>
                        <a href="javascript:;"
                           class="btn btn-product-item popper_color product-id-<?php echo $product['product_id']; ?>"
                           type="button" data-toggle="popover"><span class="">XEM MÀU</span></a>
                    </div>
                </div>
            </div>
        <?php } ?>
