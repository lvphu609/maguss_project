    ...
    <div class="mn-top">
          ...
          <div id="top-links" class="nav pull-right mgtop20">
            <ul class="list-inline">
              ...
              <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><?php echo $text_account; ?></a>
    ...
    <div class="mn-bottom">
      <div class="text-center col-lg-12 mn-top-logo">
             <?php if ($categories) { ?>
                  ...
                  <span class="dropdown mn-top-item"><a href="<?php echo $category['href']; ?>" class="dropdown-toggle" data-toggle="dropdown"><?php echo $category['name']; ?></a>
                  ...
                  <?php } else { ?>
                  <span class="mn-top-item"><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a></span>
                  <?php } ?>
                <?php } ?>
            <?php } ?>
      </div> 
