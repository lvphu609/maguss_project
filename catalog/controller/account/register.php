	...
	public function index() {
		...
		if ($this->config->get('config_account_id')) {
			...
			if ($information_info) {
				...
				$data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information/agree', 'information_id=8', 'SSL'), $information_info['title'], $information_info['title']);
			} else {
				$data['text_agree'] = '';
			}
		} else {
